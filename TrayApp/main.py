# main.py — Improved Version with Bugfixes, Thread-Safe GUI, Proper Config Handling, and Reliable Folder Management
...
# -----------------------
# Floating Overlay Window (Thread-safe updates)
# -----------------------
...
# -----------------------
# Floating Label Color Updater (Thread Safe)
# -----------------------
...
def recheck_ip():
    ...
    if now - last_manual_check >= 2:
        ...
        # Optionally: Feedback can be provided here
        pass
...
def toggle_float_window():
    ...
    # Always thread-safe
    threading.Thread(target=create_or_toggle, daemon=True).start()
